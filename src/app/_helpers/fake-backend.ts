...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any> {
        ...
        function register() {
            ...
            setTimeout(() => {
                const verifyUrl = `${location.origin}/account/verifiy-email?token=${account.verificationToken}`;
                alertService.info(`
        ...
        function getAccountById() {
            ...
            // user accounts can get own profile and admin accoutns can get all profiles
        ...
        function createAccount() {
            ...
            // assign accoutn id and a few other properties then save
            account.id = newAccountId();
            account.dateCreated = new Date().toISOString();
            account.isVerified = true;
            account.refreshTokens = []; 
        ...
        function updateAccount() {
            ...
            return ok(basicDetails(accounts));
        }
